    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (err.status === 400 && err.data?.error?.details) {
                ...
                setError(err.data?.error?.message || err.message || 'Error al crear la obra');
            }
        } finally {
        ...
        <div className="edit-project-page">
            ...
            <form onSubmit={handleSubmit} className="add-project-form">
                                            ...
                                            filteredClients.map(client => (
                                                ...
                                                >
                                                    ...
                                                    <div>
                                                        ...
                                                        {client.email && (
                                                            <span className="client-dropdown-email">{client.email}</span>
                                                        )}
                                                    </div>
                                                </div>
                                            ))
                ...
                <div className="form-actions">
                    ...
                    <Button
                        layout="icon-text-button"
                        icon={isSubmitting ? 'sync' : 'add'}
                        label={isSubmitting ? 'Guardando...' : 'Crear obra'}
                        variant="primary"
                        size="md"
                        type="submit"
